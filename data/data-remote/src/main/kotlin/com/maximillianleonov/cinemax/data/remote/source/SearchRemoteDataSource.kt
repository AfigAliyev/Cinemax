...
class SearchRemoteDataSource @Inject constructor(api: CinemaxApi) {
    private val service = api.searchService

    suspend fun getMovies(
        query: String,
        page: Int = Constants.Remote.DEFAULT_PAGE
    ) = service.getMovies(query, page)

    suspend fun getTvShows(
        query: String,
        page: Int = Constants.Remote.DEFAULT_PAGE
    ) = service.getTvShows(query, page)
}
