...
internal fun MovieDto.toDiscoverMovieEntity() = DiscoverMovieEntity(
    remoteId = id,
    title = title,
    overview = overview,
...
internal fun DiscoverMovieEntity.toMovieModel() = MovieModel(
    id = remoteId,
    title = title,
    overview = overview,
    popularity = popularity,
...
internal fun TvShowDto.toDiscoverTvShowEntity() = DiscoverTvShowEntity(
    remoteId = id,
    name = name,
    overview = overview,
    popularity = popularity,
...
internal fun DiscoverTvShowEntity.toTvShowModel() = TvShowModel(
    id = remoteId,
    name = name,
    overview = overview,
    popularity = popularity,
