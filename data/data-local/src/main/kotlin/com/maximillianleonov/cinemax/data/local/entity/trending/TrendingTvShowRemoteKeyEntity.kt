...
package com.maximillianleonov.cinemax.data.local.entity.trending
...
@Entity(tableName = Constants.Tables.TRENDING_TV_SHOWS_REMOTE_KEYS)
data class TrendingTvShowRemoteKeyEntity(
