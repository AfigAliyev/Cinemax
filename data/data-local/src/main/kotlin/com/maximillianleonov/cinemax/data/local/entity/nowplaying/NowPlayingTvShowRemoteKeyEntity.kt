...
package com.maximillianleonov.cinemax.data.local.entity.nowplaying
...
@Entity(tableName = Constants.Tables.NOW_PLAYING_TV_SHOWS_REMOTE_KEYS)
data class NowPlayingTvShowRemoteKeyEntity(
