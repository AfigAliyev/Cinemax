...
class TrendingLocalDataSource @Inject constructor(private val db: CinemaxDatabase) {
    ...
    private val tvShowDao = db.trendingTvShowDao
    private val tvShowRemoteKeyDao = db.trendingTvShowRemoteKeyDao
    ...
    suspend fun deleteAndInsertMovies(movies: List<TrendingMovieEntity>) = db.withTransaction {
        movieDao.deleteAll()
    ...
    suspend fun handleTvShowsPaging(
        ...
        tvShows: List<TrendingTvShowEntity>
    ) = db.withTransaction {
