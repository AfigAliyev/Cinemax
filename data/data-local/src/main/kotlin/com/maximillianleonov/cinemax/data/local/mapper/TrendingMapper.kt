...
internal fun MovieDto.toTrendingMovieEntity() = TrendingMovieEntity(
    remoteId = id,
    title = title,
    overview = overview,
...
internal fun TrendingMovieEntity.toMovieModel() = MovieModel(
    id = remoteId,
    title = title,
    overview = overview,
    popularity = popularity,
...
internal fun TvShowDto.toTrendingTvShowEntity() = TrendingTvShowEntity(
    remoteId = id,
    name = name,
    overview = overview,
    popularity = popularity,
...
internal fun TrendingTvShowEntity.toTvShowModel() = TvShowModel(
    id = remoteId,
    name = name,
    overview = overview,
    popularity = popularity,
